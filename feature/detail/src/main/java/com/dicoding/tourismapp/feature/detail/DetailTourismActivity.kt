...
import com.dicoding.tourismapp.feature.detail.databinding.ActivityDetailTourismBinding
...
//        detailTourismViewModel = ViewModelProvider(this, factory)[DetailTourismViewModel::class.java]
        ...
        val detailTourism = intent.getParcelableExtra<com.dicoding.tourismapp.core.domain.model.Tourism>(
            EXTRA_DATA
        )
